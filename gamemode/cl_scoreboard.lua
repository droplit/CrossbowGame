...
boardColors.ply 	= Color( 0, 0, 0, 100 )
...
function GM:HUDDrawScoreBoard()
	...
	draw.SimpleText( "Kill Streak", "PlayerNames", refx + boardWidth - 230, refy, boardColors.backText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
	draw.SimpleText( "Frags", "PlayerNames", refx + boardWidth - 160, refy, boardColors.backText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
	draw.SimpleText( "Deaths", "PlayerNames", refx + boardWidth - 100, refy, boardColors.backText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
	draw.SimpleText( "Ping", "PlayerNames", refx + boardWidth - 40, refy, boardColors.backText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
	refy = refy + 20
	...
	for i=1, #players, 1  do
		...
		draw.SimpleText( ply:GetNWInt( "killstreak" ), "ServerName", refx + boardWidth - 230, refy, boardColors.plyText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
		draw.SimpleText( ply:Frags(), "ServerName", refx + boardWidth - 160, refy, boardColors.plyText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
		draw.SimpleText( ply:Deaths(), "ServerName", refx + boardWidth - 100, refy, boardColors.plyText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
		local pingText = "" if ply:IsBot() then pingText = "Bot" else pingText = ply:Ping() end
		draw.SimpleText( pingText, "ServerName", refx + boardWidth - 40, refy, boardColors.plyText, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM )
		refy = refy + 30
